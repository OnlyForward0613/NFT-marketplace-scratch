  //  ___  __    ________  ________  ___       ___  _________  ___  ________  ________      
...
contract TheKoalition is ERC721A, Ownable, DefaultOperatorFilterer {
    uint256 public max_mints = 5;
    uint256 public max_mints_transaction = 2;
    uint256 public max_supply = 100;
    uint256 public price = 300 * 10**18;
    uint256 public discountFactor = 5;
    bool public paused = false;

    IERC20 public paymentToken;

    string public baseURI = "ipfs://bafybeictnytuexnserbdndfiid6t2tzdtrwkgty43njw3hk3u7fsbprl7y/";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("The Koalition", "TK") {
    }
    ...
    function mint(uint256 quantity) external {
        ...
        if (msg.sender != owner()) {
            ...
            require(quantity <= max_mints_transaction, "Exceeded the limit per transaction");
            ...
            if (supply + quantity <= 20) {
                ...
                if (quantity >= 2) {
                    requiredTokens = (price - (price / discountFactor)) * quantity;
                } else {
                    requiredTokens = price * quantity;
                }
            }
            
            // Replace ETH payment check with ERC-20 token payment
            require(paymentToken.transferFrom(msg.sender, address(this), requiredTokens), "Payment failed");
        }
        
        _safeMint(msg.sender, quantity);  // Assuming _safeMint is defined elsewhere in your contract
    }
